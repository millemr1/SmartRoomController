...
void loop(){
 ...
 if (averagedReadings > 600) {    //turn the lights in the room on if sound has been heard
 ...
 if (millis()-lastSound > 420000){  //turn of sound if light hasn't been heard for seven minutes
...
TeaTime = setSpecifiedTime(16,39);  
BedTime = setSpecifiedTime(16,40);
...
void makeLightsDim(){    //dim lights at specific time
 ...
 int dimLightsTime =  setSpecifiedTime(16,50);
